...
knitr::opts_knit$set(root.dir = "C:/Users/erin_/Documents/UCSB PhD/Manuscripts/AOP denticle shedding/Dryad data archiving/DillonMEPS2021_SupData_Denticle_Shedding_csv_files")
...
# Load data
read.csv(here::here("ChangesInRedList","rl_status_history_2007_2018_genuine.csv"))
## Denticle shedding data
```{r}

shed_raw <- read.csv("1_DillonMEPS2021_SupData_Denticle_Shedding_counts.csv",header=T,na.strings = ".")
...
aop_taph <- read.csv("2_DillonMEPS2021_SupData_Denticle_Shedding_weathering.csv",header=T,na.strings=".")
...
focalfol <- read.csv("5_DillonMEPS2021_SupData_Denticle_Shedding_behavior.csv",na.strings=".", header=TRUE)
